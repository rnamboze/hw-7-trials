...
2. If it was "negative", determine if it was caused by the "airline" (e.g., lost luggage, delayed flight) or by an "external issue" (e.g., weather).
...
external_issue_prompt = PromptTemplate.from_template(
    ...
    2. Politely explain that the airline is not liable in such cases and will not provide compensation.
    3. Address the customer directly in a professional tone.
