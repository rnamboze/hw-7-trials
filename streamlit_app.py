...
From the following text, determine whether the trip experience was "positive" or "negative" and respond appropriately.
...
branch = RunnableBranch(
    ...
    (lambda x: "negative" in x["trip_experience"].lower() and "airline" in x["trip_experience"].lower() or "lost luggage" in x["trip_experience"].lower(), airline_issue_prompt),
    (lambda x: "negative" in x["trip_experience"].lower() and "weather" in x["trip_experience"].lower(), external_issue_prompt),
